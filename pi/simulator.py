...
def getMovement(src, dst):
    speed = 0.00005          # divide by 10 to get back original speed
    dst_x, dst_y = dst
    x, y = src
...
def run(id, current_coords, from_coords, to_coords, SERVER_URL):
    ...
    while distance(drone_coords, from_coords) > 0.0006:      #change back distance
    ...
    while distance(drone_coords, to_coords) > 0.0006:  #change back distance
